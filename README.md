...
The SQLite database lives in your platform's app-data directory (e.g. `~/Library/Application Support/com.nexus.app/nexus.db` on macOS); the Facebook browser profile, when used, sits beside it in `fb-profile/`.
